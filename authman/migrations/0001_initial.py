    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subjects', to='authman.staff')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.AddField(
            model_name='staff',
            name='subject',
            field=models.ManyToManyField(blank=True, default='All', null=True, related_name='teachers', to='authman.subject'),
        ),
        migrations.CreateModel(
            name='Admin',
            fields=[
